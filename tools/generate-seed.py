#!/usr/bin/env python3
"""
generate-seed.py — 목 금융 데이터(`kb_user` 11건, `account` 35건,
`transaction` 약 3,130건) 생성기.
...
현재 커밋된 `schema.sql`의 시드는 `DATA_START = 2026-05-01`,
...
# =================================================================
DATA_START = datetime.date(2026, 5, 1)
...
USER_PROFILES = [
    ...
    dict(
        kb_user_id=10011, account_id=241, end_balance=560000,
